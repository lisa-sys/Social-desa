        ...
        {if $system['memories_enabled']}
          <li {if $page == "index" && $view == "memories"}class="active" {/if}>
            <a href="{$system['system_url']}/memories">
              {include file='__svg_icons.tpl' icon="memories" class="main-icon mr10" width="24px" height="24px"}
              {__("Memories")}
            </a>
          </li>
        {/if}
        ...
        {if false}
          <li {if $page == "index" && $view == "watch"}class="active" {/if}>
            <a href="{$system['system_url']}/watch">
              {include file='__svg_icons.tpl' icon="watch" class="main-icon mr10" width="24px" height="24px"}
              {__("Watch")}
            </a>
          </li>
        {/if}
      ...
      {if $system['games_enabled']}
        <li {if $page == "games"}class="active" {/if}>
          <a href="{$system['system_url']}/games">
            {include file='__svg_icons.tpl' icon="games" class="main-icon mr10" width="24px" height="24px"}
            {__("Games")}
          </a>
        </li>
      {/if}
