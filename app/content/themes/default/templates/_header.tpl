                        ...
                        {if $user->_logged_in}
                          ...
                          <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                              ...
                              {/if}
                              {if $system['points_enabled'] || $system['wallet_enabled'] || $user->_data['can_sell_products'] || $user->_data['can_raise_funding'] || $user->_data['can_monetize_content']}
                                ...
                                {/if}
                                {if $user->_data['can_sell_products']}
                                  <a class="dropdown-item d-none d-lg-block" href="{$system['system_url']}/settings/market">
                                    {include file='__svg_icons.tpl' icon="market" class="main-icon mr10" width="20px" height="20px"}
                                    {__("Marketplace")}: <span class="badge bg-light text-primary">{print_money($user->_data['user_market_balance']|number_format:2)}</span>
                                  </a>
                                {/if}
                                {if $user->_data['can_raise_funding']}
                                  <a class="dropdown-item d-none d-lg-block" href="{$system['system_url']}/settings/funding">
                                ...
                                {if $user->_data['can_monetize_content']}
                                  <a class="dropdown-item d-none d-lg-block" href="{$system['system_url']}/settings/monetization">
